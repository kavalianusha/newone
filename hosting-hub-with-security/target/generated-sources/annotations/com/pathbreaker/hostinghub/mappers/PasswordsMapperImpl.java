...
public class PasswordsMapperImpl implements PasswordsMapper {
    ...
    public DomainResponseView responseToDomainView(DomainEntity domains) {
        ...
        domainResponseView.setRegistrationEmail( domains.getRegistrationEmail() );
    ...
    public HostingResponseView responseToHostingView(HostingEntity hostings) {
        ...
        hostingResponseView.setUrl( hostings.getUrl() );
        hostingResponseView.setLogin( hostings.getLogin() );
        hostingResponseView.setPassword( hostings.getPassword() );
        hostingResponseView.setRegistrationEmailId( hostings.getRegistrationEmailId() );
        ...
        hostingResponseView.setHostingCpannelUrl( hostings.getHostingCpannelUrl() );
    ...
    public ItReturnsResponseView repsonseToItReturnsView(ItReturnsEntity itReturns) {
        ...
        itReturnsResponseView.setRegisteredEmail( itReturns.getRegisteredEmail() );
