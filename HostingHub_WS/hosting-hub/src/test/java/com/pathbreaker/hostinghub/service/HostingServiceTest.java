...
import com.pathbreaker.hostinghub.mappers.HostingMapper;
...
public class HostingServiceTest {
    ...
    public void saveHosting() {
        ...
        hostingAdd.setUrl1("http://www.twitter.com");
        ...
        hostingAdd.setDuration("vamsi87654");
        hostingAdd.setPassword("vamsi@87654");
        hostingAdd.setUrl2("http://www.facebook.com");
        ...
        reqDto.setUrl1("http://www.twitter.com");
        reqDto.setHostingId("HA006");
        reqDto.setHostingDnsName("lakshmi");
        reqDto.setDuration("priyanka9876");
        ...
        reqDto.setUrl2("http://www.facebook.com");
...
//        Mockito.when(hostingAddRepo.save(ArgumentMatchers.any())).thenReturn(hostingAdd);
        ...
        assertEquals("http://www.twitter.com", reqDto.getUrl1());
        ...
        assertEquals("priyanka9876", reqDto.getDuration());
        assertEquals("priyanka@9876", reqDto.getPassword());
        assertEquals("http://www.facebook.com", reqDto.getUrl2());
    ...
    public void getAllHosting() {
        ...
        entity1.setUrl1("http://www.twitter.com");
        ...
        entity1.setDuration("vamsi87654");
        entity1.setPassword("vamsi@87654");
        entity1.setUrl2("http://www.facebook.com");
        ...
        entity2.setUrl1("http://www.twitter.com");
        ...
        entity2.setDuration("priyanka9876");
        entity2.setPassword("priyanka@9876");
        entity2.setUrl2("http://www.facebook.com");
        ...
        hostingResponse.setUrl1("http://www.twitter.com");
        ...
        hostingResponse.setDuration("priyanka9876");
        hostingResponse.setPassword("priyanka@9876");
        hostingResponse.setUrl1("http://www.facebook.com");
        ...
        assertEquals("http://www.twitter.com", entity1.getUrl1());
        ...
        assertEquals("vamsi87654", entity1.getDuration());
        assertEquals("vamsi@87654" , entity1.getPassword());
        assertEquals("http://www.facebook.com", entity1.getUrl2());
        ...
        assertEquals("http://www.twitter.com", entity2.getUrl1());
        ...
        assertEquals("priyanka9876", entity2.getDuration());
        assertEquals("priyanka@9876" , entity2.getPassword());
        assertEquals("http://www.facebook.com", entity2.getUrl2());
    ...
    public void getHostingById() {
        ...
        expectedReqDto.setUrl1("http://www.twitter.com");
        ...
        expectedReqDto.setDuration("vamsi87654");
        expectedReqDto.setPassword("vamsi@87654");
        expectedReqDto.setUrl2("http://www.facebook.com");
...
//        Mockito.when(passwordEncoder.decryptPassword(ArgumentMatchers.anyString())).thenReturn(passwordsResponse.getPassword());
        ...
        assertEquals("http://www.twitter.com",expectedReqDto.getUrl1());
        ...
        assertEquals("vamsi87654",expectedReqDto.getDuration());
    ...
    public void updateHosting() {
        ...
        hostingAdd.setDuration("priyanka9876");
    ...
    public void deleteHostingById() {
        ...
        entity1.setDuration("priyanka9876");
