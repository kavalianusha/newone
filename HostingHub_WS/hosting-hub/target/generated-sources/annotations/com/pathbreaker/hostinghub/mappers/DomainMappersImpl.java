...
public class DomainMappersImpl implements DomainMappers {
    ...
    @Override
    public DomainResponseView responseToView(DomainEntity domainEntity) {
        if ( domainEntity == null ) {
            return null;
        }
        ...
        domainResponseView.setUserName( domainEntity.getUserName() );
        domainResponseView.setPassword( domainEntity.getPassword() );
        domainResponseView.setDomainId( domainEntity.getDomainId() );
        domainResponseView.setDomainName( domainEntity.getDomainName() );
        domainResponseView.setProviderName( domainEntity.getProviderName() );
        domainResponseView.setDomainUrl( domainEntity.getDomainUrl() );
        domainResponseView.setRegistrationDate( domainEntity.getRegistrationDate() );
        domainResponseView.setExpiryDate( domainEntity.getExpiryDate() );
        domainResponseView.setClientName( domainEntity.getClientName() );
        domainResponseView.setDuration( domainEntity.getDuration() );
        domainResponseView.setRegistrationName( domainEntity.getRegistrationName() );
        domainResponseView.setRegistrationMobileNumber( domainEntity.getRegistrationMobileNumber() );
        domainResponseView.setEmailId( domainEntity.getEmailId() );
        domainResponseView.setDaysLeft( domainEntity.getDaysLeft() );
